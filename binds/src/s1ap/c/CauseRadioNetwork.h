...
typedef enum CauseRadioNetwork {
	...
	CauseRadioNetwork_n26_interface_not_available	= 40,
	CauseRadioNetwork_insufficient_ue_capabilities	= 41,
	CauseRadioNetwork_maximum_bearer_pre_emption_rate_exceeded	= 42,
	CauseRadioNetwork_up_integrity_protection_not_possible	= 43
} e_CauseRadioNetwork;

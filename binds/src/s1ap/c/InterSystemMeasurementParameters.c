...
static asn_oer_constraints_t asn_OER_memb_measurementDuration_constr_2 CC_NOTUSED = {
	{ 1, 1 }	/* (1..100) */,
	-1};
...
asn_TYPE_member_t asn_MBR_InterSystemMeasurementParameters_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct InterSystemMeasurementParameters, measurementDuration),
		...
		0,
		{ &asn_OER_memb_measurementDuration_constr_2, &asn_PER_memb_measurementDuration_constr_2,  memb_measurementDuration_constraint_1 },

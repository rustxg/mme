...
typedef enum InitiatingMessage__value_PR {
	...
	InitiatingMessage__value_PR_ENBEarlyStatusTransfer,
	InitiatingMessage__value_PR_MMEEarlyStatusTransfer
...
typedef struct InitiatingMessage {
	...
	struct InitiatingMessage__value {
		...
		union InitiatingMessage__value_u {
			...
			ENBEarlyStatusTransfer_t	 ENBEarlyStatusTransfer;
			MMEEarlyStatusTransfer_t	 MMEEarlyStatusTransfer;
		} choice;

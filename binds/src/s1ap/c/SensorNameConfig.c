 ...
 */
static asn_oer_constraints_t asn_OER_type_uncompensatedBarometricConfig_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_SensorNameConfig_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_uncompensatedBarometricConfig_2 = {
	...
	{ &asn_OER_type_uncompensatedBarometricConfig_constr_2, &asn_PER_type_uncompensatedBarometricConfig_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_SensorNameConfig_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SensorNameConfig, choice.choice_Extensions),
...
asn_TYPE_descriptor_t asn_DEF_SensorNameConfig = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_SensorNameConfig_constr_1, &asn_PER_type_SensorNameConfig_constr_1, CHOICE_constraint },

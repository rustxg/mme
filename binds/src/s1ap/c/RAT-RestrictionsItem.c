...
static int
memb_rAT_RestrictionInformation_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_rAT_RestrictionInformation_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
static asn_per_constraints_t asn_PER_memb_rAT_RestrictionInformation_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  0,  0,  8,  8 }	/* (SIZE(8..8,...)) */,
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_RAT_RestrictionsItem_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RAT_RestrictionsItem, pLMNidentity),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RAT_RestrictionsItem, rAT_RestrictionInformation),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_rAT_RestrictionInformation_constr_3, &asn_PER_memb_rAT_RestrictionInformation_constr_3,  memb_rAT_RestrictionInformation_constraint_1 },
		0, 0, /* No default value */
